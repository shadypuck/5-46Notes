...
\tikzset{
    wvbnd/.style={decorate,decoration={snake,amplitude=0.5mm,segment length=2.2mm}},
    noesy/.style={blx,semithick,{Stealth[round,scale=1.1,inset'=0pt 0.55]}-{Stealth[round,scale=1.1,inset'=0pt 0.55]},shorten <=#1,shorten >=#1}
}
