...
\begin{itemize}
    \item \marginnote{3/20:}NMR dynamics.
    \begin{itemize}
        \item Hydrogen bonding can be probed with \ce{H}/\ce{D} exchange or saturation transfer with water.
    ...
    \begin{itemize}
        ...
        \item Solvent suppression is often necessary. Deuterated solvents are often too expensive, and some (like \ce{D2O}) may exchange in or alter the kinetics (e.g., inadvertent KIEs).
